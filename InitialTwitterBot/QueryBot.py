...
'''
    ...
    Requires a file named "twitterkeys.py" of the format:
        consumer_key = 'Rc0V4xFWDkbhp1qgrCJashgpW'
        consumer_secret = '4QQt2liiDUCLAXqL1NbOOs8LsunRfoq7XIfXjIXlPlDMwLmp7D'
        access_token = '15851670-BaUqY3YyWQTppvBnrghincaVExzgYXRjZEHZQJgOD'
        access_secret = 'P29Z7IWpQir22qSaeP3Yjl38iQqxZxiI0KzT4sEScpUPE'
